...
use App\Http\Controllers\Vendor\SellerInsuranceController;
use App\Http\Controllers\Vendor\SellerHomepagePromotionController;
use App\Http\Controllers\Vendor\SellerPackageController;
use App\Http\Controllers\Vendor\SellerSearchPromotionController;
        ...
        Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
            ...
            Route::group(['prefix' => 'registration', 'as' => 'registration.'], function () {
                Route::controller(RegisterController::class)->group(function () {
                    ...
                    Route::get('verify-phone', 'getPhoneVerificationView')->name('verify-phone');
                    Route::post('verify-phone', 'verifyPhone')->name('verify-phone.submit');
        ...
        Route::group(['middleware' => ['seller']], function () {
            Route::group(['prefix' => 'packages', 'as' => 'packages.'], function () {
                Route::controller(SellerPackageController::class)->group(function () {
                    ...
                    Route::post('offline-payment', 'submitOfflinePayment')->name('offline-payment');
                });
            });
            ...
            Route::group(['prefix' => 'promotions/search', 'as' => 'promotions.search.'], function () {
                Route::controller(SellerSearchPromotionController::class)->group(function () {
                    Route::get('/', 'index')->name('index');
                    Route::post('activate', 'activate')->name('activate');
                });
            });

            Route::group(['prefix' => 'promotions/homepage', 'as' => 'promotions.homepage.'], function () {
                Route::controller(SellerHomepagePromotionController::class)->group(function () {
                    Route::get('/', 'index')->name('index');
                    Route::post('activate', 'activate')->name('activate');
                });
            });

            // V2 sidebar pin shortcuts (server-side persistence, per-seller)
            Route::group(['prefix' => 'v2/sidebar-pins', 'as' => 'v2.sidebar-pins.'], function () {
                Route::get('/', [\App\Http\Controllers\Vendor\V2SidebarPinController::class, 'index'])->name('index');
                Route::post('toggle',  [\App\Http\Controllers\Vendor\V2SidebarPinController::class, 'toggle'])->name('toggle');
