            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/promotions/search*')?'active' : ''}}">
                            <a class="nav-link" href="{{ route('vendor.promotions.search.index') }}" title="{{ translate('Featured_Search_Ads') }}">
                                <i class="tio-trending-up nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('Featured_Search_Ads') }}
                                </span>
                            </a>
                        </li>

                        <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/promotions/homepage*')?'active' : ''}}">
                            <a class="nav-link" href="{{ route('vendor.promotions.homepage.index') }}" title="{{ translate('Homepage_Featured_Offers') }}">
                                <i class="tio-home nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('Homepage_Featured_Offers') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/packages*')?'active' : ''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('vendor.packages.index') }}" title="{{ translate('Vendor_Packages') }}">
                                <i class="tio-premium-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                                    {{ translate('Vendor_Packages') }}
                                </span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor/insurance*')?'active' : ''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('vendor.insurance.index') }}" title="{{ translate('Vendor_Insurance') }}">
                                <i class="tio-shield nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                                    {{ translate('Vendor_Insurance') }}
                                </span>
                            </a>
                        </li>
