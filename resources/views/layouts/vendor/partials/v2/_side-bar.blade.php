...
<aside class="v2-ctxpanel" id="v2-ctxpanel">
    ...
    <div class="v2-ctx-section" data-section="marketing">
        ...
        <div class="v2-ctx-group">
            ...
            <a class="v2-nav-item {{ Request::is('vendor/promotions/search*') ? 'v2-is-active' : '' }}" data-item="v-search-promotions" href="{{ route('vendor.promotions.search.index') }}">
                <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('Featured_Search_Ads') }}</span></span>
                <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="v-search-promotions" aria-label="Pin"></button></div>
            </a>
            <a class="v2-nav-item {{ Request::is('vendor/promotions/homepage*') ? 'v2-is-active' : '' }}" data-item="v-homepage-promotions" href="{{ route('vendor.promotions.homepage.index') }}">
                <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('Homepage_Featured_Offers') }}</span></span>
                <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="v-homepage-promotions" aria-label="Pin"></button></div>
            </a>
        </div>
    </div>
    ...
    <div class="v2-ctx-section" data-section="settings">
        ...
        <div class="v2-ctx-group">
            ...
            <a class="v2-nav-item {{ Request::is('vendor/packages*') ? 'v2-is-active' : '' }}" data-item="v-packages" href="{{ route('vendor.packages.index') }}">
                <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('Vendor_Packages') }}</span></span>
                <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="v-packages" aria-label="Pin"></button></div>
            </a>
            <a class="v2-nav-item {{ Request::is('vendor/insurance*') ? 'v2-is-active' : '' }}" data-item="v-insurance" href="{{ route('vendor.insurance.index') }}">
                <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('Vendor_Insurance') }}</span></span>
                <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="v-insurance" aria-label="Pin"></button></div>
            </a>
