    ...
    <div class="aside-body search-aside-attribute-container py-4 pt-0">
        ...
        <ul class="aside-nav navbar-nav gap-2">
            ...
            @if(Helpers::module_permission_check('people'))
                ...
                <li class="{{ (Request::is('admin/customer/wallet*') || Request::is('admin/customer/purchase-package*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report')) ? 'sub-menu-opened' : '' }}">
                    <a class="nav-link nav-link-toggle {{ (Request::is('admin/customer/wallet*') || Request::is('admin/customer/purchase-package*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report')) ? 'active' : '' }}"
                    ...
                    <ul class="aside-submenu navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (Request::is('admin/customer/purchase-package') || Request::is('admin/customer/purchase-package/edit*')) ? 'active' : '' }}"
                               title="{{ translate('Customer_Purchase_Packages') }}"
                               href="{{ route('admin.customer.purchase-package.index') }}">
                                <span class="text-truncate">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/customer/purchase-package/offline-payment-reviews*') ? 'active' : '' }}"
                               title="{{ translate('Activation_Offline_Payments') }}"
                               href="{{ route('admin.customer.purchase-package.offline-payment-reviews') }}">
                                <span class="text-truncate">
                                    {{ translate('Activation_Offline_Payments') }}
                                </span>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="{{ Request::is('admin/vendors*') || Request::is('admin/vendors/withdraw-method/*') || (Request::is('admin/orders/details/*') && request()->has('vendor-order-list')) ? 'sub-menu-opened' : '' }}">
                    ...
                    <ul class="aside-submenu navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/vendors/quota-control*') ? 'active' : '' }}" title="{{ translate('Vendor_Package_Control') }}" href="{{ route('admin.vendors.quota-control.index') }}">
                                <span class="text-truncate">{{ translate('Vendor_Package_Control') }}</span>
                            </a>
                        </li>
                        @if (Helpers::module_permission_check('business_settings'))
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('admin/business-settings/vendor-settings') ? 'active' : '' }}"
                                   title="{{ translate('Vendor_Insurance_Settings') }}"
                                   href="{{ route('admin.business-settings.vendor-settings.index') }}#vendor-insurance-settings">
                                    <span class="text-truncate">{{ translate('Vendor_Insurance_Settings') }}</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/vendors/packages*') ? 'active' : '' }}"
                               title="{{ translate('Vendor_Packages') }}"
                               href="{{ route('admin.vendors.packages.index') }}">
                                <span class="text-truncate">{{ translate('Vendor_Packages') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/vendors/package-payments*') ? 'active' : '' }}"
                               title="{{ translate('Package_Offline_Reviews') }}"
                               href="{{ route('admin.vendors.package-payments.index') }}">
                                <span class="text-truncate">{{ translate('Package_Offline_Reviews') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/vendors/insurance-payments*') ? 'active' : '' }}"
                               title="{{ translate('Insurance_Offline_Reviews') }}"
                               href="{{ route('admin.vendors.insurance-payments.index') }}">
                                <span class="text-truncate">{{ translate('Insurance_Offline_Reviews') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
