                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between gap-2">
                            ...
                            <label class="switcher" for="commission-status">
                                <input
                                    ...
                                    {{ $commissionSummary['custom_enabled'] ? 'checked':'' }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $commissionSummary['custom_enabled'] ? $commissionSummary['custom_rate'] : $commissionSummary['default_rate'] }}"
                                       class="form-control" name="commission" min="0" max="100" step="0.01" required>
                                <small class="text-muted">{{ translate('Effective_Commission') }}: {{ number_format($commissionSummary['effective_rate'], 2) }}% ({{ translate($commissionSummary['source']) }})</small>
                            </div>
