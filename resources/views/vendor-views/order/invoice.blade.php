                            ...
                            <table>
                                ...
                                @if($order['edited_status'] == 1 && ($order?->latestEditHistory?->order_due_payment_status == "paid" || $order?->latestEditHistory?->order_due_payment_status == "cash_on_delivery"))
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt-1 pb-1">:</td>
                                        <td class="px-2 pt-1 pb-1"><span
                                                class="text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order?->latestEditHistory?->order_due_amount), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                @elseif($order->edited_status == 1 && $order?->latestEditHistory?->order_return_payment_status == "returned")
                                    ...
                                    <tr>
                                        <td class="px-2 pt-1 pb-1">{{ translate('After_editing_your_product_list_you_will_return_') }} {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order?->latestEditHistory?->order_return_amount), currencyCode: getCurrencyCode())  }}</td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
        ...
        <table class="table">
            ...
            @foreach($order->details as $key=>$details)
                ...
                <tr>
                    ...
                    <td class="px-2 pt-1 pb-1 text-right">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $details['price']), currencyCode: getCurrencyCode()) }}</td>
                    <td class="px-2 pt-1 pb-1 text-right">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $details['price'] * $details['qty']), currencyCode: getCurrencyCode()) }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
                            ...
                            <td class="text-right">
                                <table class="ml-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 pt-1 pb-1 text-right">
                                            <span
                                                class="text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['itemPrice']), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="px-2 pt-1 pb-1 text-right">
                                            <span
                                                class="text-dark">-{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['itemDiscount']), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                    @if ($order->order_type != 'default_type')
                                        <tr>
                                            ...
                                            <td class="px-2 pt-1 pb-1 text-right">
                                                <span
                                                    class="text-dark">-{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['extraDiscount']), currencyCode: getCurrencyCode()) }}</span>
                                            </td>
                                        </tr>
                                    @endif
                                    <tr>
                                        ...
                                        <td class="px-2 pt-1 pb-1 text-right">
                                            <span
                                                class="text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['subTotal']), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="px-2 pt-1 pb-1 text-right">
                                            <span
                                                class="text-dark">-{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['couponDiscount']), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                    @if($orderTotalPriceSummary['referAndEarnDiscount'] > 0)
                                        <tr>
                                            ...
                                            <td class="px-2 pt-1 pb-1 text-right">
                                                <span
                                                    class="text-dark">-{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['referAndEarnDiscount']), currencyCode: getCurrencyCode()) }}</span>
                                            </td>
                                        </tr>
                                    @endif
                                    <tr>
                                        ...
                                        <td class="px-2 pt-1 pb-1 text-right">
                                            <span
                                                class="text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['taxTotal']), currencyCode: getCurrencyCode()) }}</span>
                                        </td>
                                    </tr>
                                    @if($order->order_type == 'default_type' && $order?->is_shipping_free != 1)
                                        <tr>
                                            ...
                                            <td class="px-2 pt-1 pb-1 text-right">
                                                <span
                                                    class="text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['shippingTotal']), currencyCode: getCurrencyCode()) }}</span>
                                            </td>
                                        </tr>
                                    @endif
                                    <tr>
                                        ...
                                        <td colspan="2" class="text-right">
                                            <table class="ml-auto w-100">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-2 pt-1 pb-1 text-right">
                                                        <h5 class="m-0">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['totalAmount']), currencyCode: getCurrencyCode()) }}</h5>
                                                    </td>
                                                </tr>
                                                @if ($order->order_type == 'POS' || $order->order_type == 'pos')
                                                    <tr>
                                                        ...
                                                        <td class="px-2 pt-1 pb-1 text-right">
                                                            <p class="m-0 text-dark">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['paidAmount']), currencyCode: getCurrencyCode()) }}</p>
                                                        </td>
                                                    </tr>
                                                @endif
                                                    ...
                                                    @if($order?->latestEditHistory?->order_due_amount > 0)
                                                        @if($order?->latestEditHistory?->order_due_payment_status == 'paid')
                                                            <tr>
                                                                ...
                                                                <td class="px-2 pt-1 pb-1 text-right">
                                                                    <h5 class="m-0">
                                                                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order?->latestEditHistory?->order_amount
                                                                                - $order?->latestEditHistory?->order_due_amount), currencyCode: getCurrencyCode()) }}
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        @if($order?->latestEditHistory?->order_return_payment_status == 'returned')
                                                            <tr>
                                                                ...
                                                                <td class="px-2 pt-1 pb-1 text-right">
                                                                    <h5 class="m-0">
                                                                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $order?->latestEditHistory?->order_amount
                                                                                + $order?->latestEditHistory?->order_return_amount), currencyCode: getCurrencyCode()) }}
                                                                    </h5>
                                                                </td>
                                                            </tr>
                                                ...
                                                @if ($order->order_type == 'POS' || $order->order_type == 'pos')
                                                    <tr>
                                                        ...
                                                        <td class="px-2 pt-1 pb-1 text-right">
                                                            <h5 class="m-0">{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['changeAmount']), currencyCode: getCurrencyCode()) }}</h5>
                                                        </td>
                                                    </tr>
                                                @endif
                                                </tbody>
