                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            <h5 class="font-bold m-0 fs-16">{{ translate('customer_purchase_packages') }}</h5>
                            ...
                            <div class="border rounded p-3 mb-4">
                                ...
                                @else
                                    ...
                                    @include('system-partials._purchase-package-offline-payment-modals', [
                                        ...
                                        'modalIdPrefix' => 'activation-invoice-' . $pendingActivationInvoice->id,
                                ...
                                <div class="col-md-6">
                                    <div class="border rounded p-3 h-100 d-flex flex-column">
                                        <div class="d-flex justify-content-between gap-2 mb-2">
                                            <div>
                                                ...
                                                @if($package->is_custom)
                                                    <span class="badge badge-soft-info">{{ translate('custom_package') }}</span>
                                                @endif
                                            </div>
                                            <div class="text-end">
                                        ...
                                        @include('system-partials._purchase-package-offline-payment-modals', [
                                            ...
                                            'modalIdPrefix' => 'package-' . $package->id,
