...
<p class="text-center text-muted">
    {{ translate('sorry_the_number_and_email_you_provided_during_order_is_incorrect').' '.translate('we_cannot_send_any_verification_code').' '.translate('please_open_a_support_ticket_to_contact_the_platform') }}
</p>
