                                        ...
                                        <div class="bg-light my-2 rounded-10 p-4">
                                            <div class="d-flex align-items-center justify-content-between gap-3">
                                                @foreach($order['details']->take(3) as $key=>$detail)
                                                    <div>
                                                        <img width="42" alt="{{ translate('Product') }}" class="dark-support rounded" loading="lazy"
                    ...
                    <div class="p-3 p-sm-4">
                        <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4">
                            <h2 class="text-capitalize">
                                <span class="text-primary">{{translate('find')}}</span> {{translate('what_you_need')}}
                            </h2>
                        ...
                        <div class="swiper-container">
                                        ...
                                        @foreach($final_category as $key => $category)
                                            <div class="swiper-slide align-items-start bg-white">
                                                <div class="flexible-grid md-down-1 gap-3 w-100 width-1fr bg-light rounded overflow-hidden p-2">
                                                    <div class="rounded max-w-100-mobile overflow-hidden min-w-0">
                                                        <div
                                                        ...
                                                        <div class="find-what-you-need-items">
                                                            @foreach($category['childes'] as $sub_category)
                                                                ...
                                                                class="d-flex flex-column gap-2 mb-3 align-items-center flex-shrink-0 flex-grow-0">
                                                                    <div
                                                                        class="img-wrap bg-white rounded justify-content-center d-flex">
                                                                        ...
                                                                        <div
                                                                            class="ov-hidden rounded w-80px aspect-1">
                                                                            <img alt="{{ $sub_category['name'] }}" loading="lazy" class="dark-support img-fit"
                                                                                src="{{ getStorageImages(path: $sub_category['icon_full_url'], type:'category') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="truncate text-center">
                                                                        {{ \Illuminate\Support\Str::limit($sub_category['name'] ?? '', 10, '...') }}
                                                                    </div>
                                                                </a>
                                                            @endforeach
                                                        </div>
                            ...
                            <div class="position-relative d-none d-md-block">
                                <div class="swiper" data-swiper-loop="true" data-swiper-margin="16"
                                    data-swiper-speed="200000000000" data-swiper-pagination-el="null"
                                    data-swiper-navigation-next=".find-what-you-need-nav-next"
                                    data-swiper-navigation-prev=".find-what-you-need-nav-prev">
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide align-items-start bg-white">
                                                <div class="flexible-grid md-down-1 gap-3 w-100 width-1fr">
                                                    @foreach($all_category as $key=>$category)
                                                        <div class="bg-light rounded p-4 min-w-0">
                                                            <div
                                                                class="d-flex flex-wrap justify-content-between gap-3 mb-3 align-items-start">
                                                                <div class="">
                                                                    <h5 class="mb-1 text-truncate width--16ch">
                                                            ...
                                                            <div class="find-what-you-need-items">
                                                                @foreach($category['childes'] as $sub_category)
                                                                    <a href="{{ route('category-products', ['slug' => $sub_category['slug']]) }}"
                                                                    class="d-flex flex-column gap-2 mb-3 align-items-center flex-shrink-0 flex-grow-0">
                                                                        <div class="img-wrap bg-white rounded justify-content-center d-flex">
                                                                            <div class="floting-text">
                                                                            <span class="truncate text-center">
                                                                                <span>
                                                                                    {{
                                        ...
                                        <div class="d-flex flex-column gap-2 p-3">
                                            ...
                                            <h6 class="fs-12">
                                                ...
                                                @if($coupon->seller_id == '0')
                                                    ...
                                                    @else
                                                        <a class="shop-name" href="{{isset($coupon->seller->shop) ? route('vendor-shop',['slug'=>$coupon->seller->shop['slug']]) : 'javascript:'}}">
