...
@section('content')
                ...
                <div class="col-lg-9">
                    <div class="card mb-3 border-0">
                        <div class="flexible-grid md-down-1 width--15-625">
                            <div class="bg-light h-100 min-height-100vh-300px">
                                <div class="p-3">
                                    ...
                                    <div class="tab-pane fade show active" id="seller-tab-pane" role="tabpanel"
                                        ...
                                        <div class="chat-list chatting-scrollbar">
                                            @if(isset($allChattingUsers) && count($allChattingUsers) > 0)
                                                ...
                                                @endforeach
                                            @else
                                                <div id="no-result" class="text-center text-muted py-3">
    ...
    <span id="no-result-content" data-text="{{ translate('No Result Found') }}"></span>
@endsection
