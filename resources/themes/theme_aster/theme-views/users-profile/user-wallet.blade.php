                        ...
                        <div class="modal-body px-5">
                            ...
                            <form action="{{ route('customer.add-fund-request') }}" method="post"
                                ...
                                <div class="pb-4">
                                    ...
                                    <input type="number" class="h-70 form-control text-center text-24 rounded-10 only-number-input-with-decimal-point"
                                           id="add-fund-amount-input" min="1" name="amount" autocomplete="off" required
                                           placeholder="{{ \App\Utils\currency_symbol() }}500" step="any">
