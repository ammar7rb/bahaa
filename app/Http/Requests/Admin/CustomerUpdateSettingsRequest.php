...
class CustomerUpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'customer_shipping_same_day_title' => 'nullable|string|max:191',
            'customer_shipping_same_day_duration' => 'nullable|string|max:191',
            'customer_shipping_same_day_cost' => 'nullable|numeric|min:0',
            'customer_shipping_same_day_cutoff' => 'nullable|date_format:H:i',
            'customer_shipping_next_day_title' => 'nullable|string|max:191',
            'customer_shipping_next_day_duration' => 'nullable|string|max:191',
            'customer_shipping_next_day_cost' => 'nullable|numeric|min:0',
            'customer_shipping_normal_title' => 'nullable|string|max:191',
            'customer_shipping_normal_duration' => 'nullable|string|max:191',
