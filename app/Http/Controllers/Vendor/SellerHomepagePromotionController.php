...
class SellerHomepagePromotionController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('vendor-views.promotion.homepage', [
            'products' => $products,
            'summary' => $this->promotionService->getHomepageSummary($seller),
    ...
    public function activate(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            ToastMagic::success(translate('homepage_promotion_activated_until').' '.$promotion->expires_at);
