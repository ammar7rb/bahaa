...
const CACHE_FOR_VENDOR_WISE_PRODUCTS_COUNT = 'cache_for_vendor_wise_products_count';
...
const CACHE_FOR_ADMIN_SIDEBAR_ALL_PRODUCT_LIST = 'cache_for_admin_sidebar_all_product_list';
